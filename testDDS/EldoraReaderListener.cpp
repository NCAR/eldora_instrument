...
void EldoraReaderListenerImpl::on_liveliness_changed (
						      DDS::DataReader_ptr,
...
void EldoraReaderListenerImpl::on_subscription_match (
						      DDS::DataReader_ptr,
...
void EldoraReaderListenerImpl::on_sample_rejected(
						  DDS::DataReader_ptr,
...
void EldoraReaderListenerImpl::on_sample_lost(
					      DDS::DataReader_ptr,
