...
class EldoraRadarParams
{
public:
    EldoraRadarParams();

    // dump the fields to std::cout 
    void dump();

    // Get the volume date/time as a boost::posix_time::ptime
    boost::posix_time::ptime getVolumeDateTime();
    ...
    int vold_date[3];   /// <day>,<month>,<year - 1900>
    int vold_time[3];   /// <hour>,<minute>,<second>
};
