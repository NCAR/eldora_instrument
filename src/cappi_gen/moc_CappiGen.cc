...
**
** Created: Fri Jul 18 16:53:30 2008
...
static const char qt_meta_stringdata_CappiGen[] = {
    "CappiGen\0\0"
    "p,radarId,elDegrees,prodType,gateSizeMeters,dwellWidth,airspdCorr,rollAngle,timetag,longitude,latitude,elevation,heading,roll,pitch,groundSpeedEW,groundSpeedNS\0"
    "productSlot(std::vector<double>,int,float,int,float,double,double,double,qlonglong,double,double,double,double,double,double,double,double)\0"
};
