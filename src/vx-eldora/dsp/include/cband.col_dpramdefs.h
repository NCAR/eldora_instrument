 ...
 * ----------------
 * $Log$
 * Revision 1.1  1994/07/18  20:11:08  eric
 * Initial revision
 *
 * Revision 1.1  1991/12/09  17:45:33  eric
 * Initial revision
 *
 *
 *
...
#define COL_NFFT_WORDS 512	/* how many points */
#define COL_MFFT_TWO 9		/* corresponding power of two */
