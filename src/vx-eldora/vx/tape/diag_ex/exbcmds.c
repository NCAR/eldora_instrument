...
unsigned char exb_cmds(unsigned int cmnd_ident,unsigned char op_cd,unsigned char drv_num)
{
...
switch(cmnd_ident)
  {
    ...
    case VERIFY:
      ...
      op5=0x00;
      break;
    case RCV_DIAGNOSTICS:
      vme_addr=(unsigned int)&rcv_results;
      xfer_count=0x00000000;
      op1=0x00;
      op2=0x00;
      op3=0x00;
