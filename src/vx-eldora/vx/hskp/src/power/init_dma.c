 ...
 * ----------------
 * $Log$
 * Revision 1.2  1997/11/12  19:37:39  eric
 * modified to use Graph Mode for xmit pulse.
 *
 * Revision 1.1  1993/09/20  17:35:59  reif
 * Initial revision
 *
...
void init_dma(int channel,int bytecount)
{
...
/************** DMA CHANNEL 0 *****************/
    ...
    *d0btc=0xff & bytecount; /* Base transfer count set for 28 bytes in continuous mode and 30 in update now mode */
    *d0mtc=0xff & bytecount; /* Memory transfer count set to 28 or 30 bytes before interrupt */
...
/************ DMA CHANNEL 1 ****************/
    ...
    *d1btc=0xff & bytecount; /* Base transfer count set for 24 bytes in continue mode */
    *d1mtc=0xff & bytecount; /* Memory transfer count set to 24 bytes before interrupt */
