...
//Bridge Address Registers
	...
	#define BRG_M332DAC_PLL_LOCK	0x12C
	...
	#define BRG_M332_SER_CLK_DAC 0x130
	...
	#define BRG_ACTL_ADR	    BRG_HWCONF_ADR
		...
		//M332
		#define M332_ADCB_HIRANGE	(0x0<<5)
		#define M332_ADCB_LORANGE	(0x1<<5)
		#define M332_ADCA_HIRANGE	(0x0<<4)
		#define M332_ADCA_LORANGE	(0x1<<4)
		#define M332_ADCB_RAND_ON	(0x1<<3)
		#define M332_ADCB_RAND_OFF	(0x0<<3)
		#define M332_ADCA_RAND_ON 	(0x1<<2)
		#define M332_ADCA_RAND_OFF 	(0x0<<2)
		#define M332_ADCB_DITHER_ON	(0x1<<1)
		#define M332_ADCB_DITHER_OFF (0x0<<1)
		#define M332_ADCA_DITHER_ON  (0x1<<0)
		#define M332_ADCA_DITHER_OFF (0x0<<0)
	...
	#define BRG_M316_CLK_CTLA_ADR	0x208		/*For M316*/

	#define BRG_M332_DAC_CTL_ADR	0x208		/*For M332*/
		#define DAC_RESET			0x0
		#define TX_ENABLE			(0x1<<1)


	#define BRG_M320CHB_ATTN_ADR	0x20C		/*For M320*/
	#define BRG_M316CLK_CTLB_ADR	0x20C		/*For M316*/
	
	#define BRG_M320_FPGAATTNCTL_ADR 0x210		/*For M320*/
		#define ALLOW_FPGA_ATTN_CTL 0x1
	
	#define BRG_DACCTL_OUTPUT_EN	0x210		/*For M332*/
