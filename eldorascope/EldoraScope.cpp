...
//////////////////////////////////////////////////////////////////////
void
EldoraScope::saveImageSlot() {
	QString f = _config.getString("imageSaveDirectory", "c:/").c_str();

	QFileDialog d(this, tr("Save EldoraScope Image"),
...
////////////////////////////////////////////////////////////////////
void
EldoraScope::plotTypeSlot(int plotType) {
	...
	if (pageNum == 0) {
		...
		plotTypeChange(&_pulsePlotInfo[plotType], plotType, (PRODUCT_PLOT_TYPES)0 , true);
	} else {
		// change to a product plot type
		PRODUCT_PLOT_TYPES productType = (PRODUCT_PLOT_TYPES)ptype;
		plotTypeChange(&_prodPlotInfo[productType], (TS_PLOT_TYPES)0, productType , false);
	}
}
//////////////////////////////////////////////////////////////////////
void
EldoraScope::tabChangeSlot(QWidget* w) 
{
	// find out the index of the current page
	int pageNum = _typeTab->currentIndex();
...
////////////////////////////////////////////////////////////////////
void
EldoraScope::plotTypeChange(PlotInfo* pi, 
...
EldoraScope::initPlots()
{
	...
	_pulsePlotInfo[TS_TIMESERIES_PLOT]  = PlotInfo( TS_TIMESERIES_PLOT, SCOPE_PLOT_TIMESERIES, "I and Q", "S:  I and Q", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_pulsePlotInfo[TS_IVSQ_PLOT]          = PlotInfo(         TS_IVSQ_PLOT,       SCOPE_PLOT_IVSQ, "I vs Q", "S:  I vs Q", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_pulsePlotInfo[TS_SPECTRUM_PLOT]    = PlotInfo(   TS_SPECTRUM_PLOT,   SCOPE_PLOT_SPECTRUM, "Power Spectrum", "S:  Power Spectrum", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);

	_prodPlotInfo[PROD_S_DBMHC]       = PlotInfo(      PROD_S_DBMHC,    SCOPE_PLOT_PRODUCT, "H Dbm", "Sh: Dbm", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_prodPlotInfo[PROD_S_DBMVC]       = PlotInfo(      PROD_S_DBMVC,    SCOPE_PLOT_PRODUCT, "V Dbm", "Sv: Dbm", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_prodPlotInfo[PROD_S_DBZ]         = PlotInfo(      PROD_S_DBZ,      SCOPE_PLOT_PRODUCT, "Dbz",   "S : Dbz", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_prodPlotInfo[PROD_S_WIDTH]       = PlotInfo(      PROD_S_WIDTH,    SCOPE_PLOT_PRODUCT, "Width", "S:  Width", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_prodPlotInfo[PROD_S_VEL]         = PlotInfo(      PROD_S_VEL,      SCOPE_PLOT_PRODUCT, "Velocity", "S:  Velocity", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_prodPlotInfo[PROD_S_SNR]         = PlotInfo(      PROD_S_SNR,      SCOPE_PLOT_PRODUCT, "SNR", "S:  SNR", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_prodPlotInfo[PROD_S_RHOHV]       = PlotInfo(      PROD_S_RHOHV,    SCOPE_PLOT_PRODUCT, "Rhohv", "S:  Rhohv", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_prodPlotInfo[PROD_S_PHIDP]       = PlotInfo(      PROD_S_PHIDP,    SCOPE_PLOT_PRODUCT, "Phidp", "S:  Phidp", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_prodPlotInfo[PROD_S_ZDR]         = PlotInfo(      PROD_S_ZDR,      SCOPE_PLOT_PRODUCT, "Zdr", "S:  Zdr", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);

	_prodPlotInfo[PROD_X_DBMHC]       = PlotInfo(      PROD_X_DBMHC,    SCOPE_PLOT_PRODUCT, "H Dbm", "Xh: Dbm", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_prodPlotInfo[PROD_X_DBMVX]       = PlotInfo(      PROD_X_DBMVX,    SCOPE_PLOT_PRODUCT, "V Cross Dbm", "Xv: Dbm", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_prodPlotInfo[PROD_X_DBZ]         = PlotInfo(      PROD_X_DBZ,      SCOPE_PLOT_PRODUCT, "Dbz",  "X: Dbz", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_prodPlotInfo[PROD_X_SNR]         = PlotInfo(      PROD_X_SNR,      SCOPE_PLOT_PRODUCT, "SNR", "Xh: SNR", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_prodPlotInfo[PROD_X_WIDTH]       = PlotInfo(      PROD_X_WIDTH,    SCOPE_PLOT_PRODUCT, "Width", "Xh: Width", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_prodPlotInfo[PROD_X_VEL]         = PlotInfo(      PROD_X_VEL,      SCOPE_PLOT_PRODUCT, "Velocity", "Xh: Velocity", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
	_prodPlotInfo[PROD_X_LDR]         = PlotInfo(      PROD_X_LDR,      SCOPE_PLOT_PRODUCT, "LDR", "Xhv:LDR", -5.0, 5.0, 0.0, -5.0, 5.0, 0.0);
...
//////////////////////////////////////////////////////////////////////
QButtonGroup*
EldoraScope::addPlotTypeTab(std::string tabName, std::set<TS_PLOT_TYPES> types)
{
...
//////////////////////////////////////////////////////////////////////
QButtonGroup*
EldoraScope::addProductTypeTab(std::string tabName, std::set<PRODUCT_PLOT_TYPES> types)
{
	// The page that will be added to the tab widget
	QWidget* pPage = new QWidget;
	// the layout manager for the page, will contain the buttons
...
//////////////////////////////////////////////////////////////////////
void
EldoraScope::timerEvent(QTimerEvent*) 
{
...
//////////////////////////////////////////////////////////////////////
void 
EldoraScope::autoScale(std::vector<double>& data)
{
	if (data.size() == 0) {
		_performAutoScale = false;
		return;
...
//////////////////////////////////////////////////////////////////////
void 
EldoraScope::autoScale(std::vector<double>& data1, std::vector<double>& data2)
{
...
//////////////////////////////////////////////////////////////////////
void 
EldoraScope::adjustGainOffset(double min, double max)
{
	double factor = 0.8;
