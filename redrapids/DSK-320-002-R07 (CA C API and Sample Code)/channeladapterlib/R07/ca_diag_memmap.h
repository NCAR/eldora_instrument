...
//V4 User Registers
	...
	#define V4_TXADAC_BUFFER_STARTADDR 0x10000
	#define V4_TXBDAC_BUFFER_STARTADDR 0x20000

	#define V4_TXADAC_BUFFER_CNT_SELN		0x11000
	#define V4_TXBDAC_BUFFER_CNT_SELN		0x21000

	#define	V4_TXADAC_OUTPUT_REG_SELN		0x11004
	#define V4_TXBDAC_OUTPUT_REG_SELN		0x21004
	
	#define V4_TXADAC_OUTPUT_EN	0x11008
	#define V4_TXBDAC_OUTPUT_EN	0x21008
