...
#define WD_VER_STR  WD_PROD_NAME " v" WD_VERSION_STR " Jungo (c) 1997 - 2006 Build Date: " __DATE__ WD_CPU_SPEC WD_DATA_MODEL WD_FILE_FORMAT
...
#define IOCTL_WD_CARD_REGISTER            WD_CTL_CODE(0x9ab)
...
#define IOCTL_WD_EVENT_REGISTER           WD_CTL_CODE(0x9ac)
...
#define IOCTL_WD_WATCH_PCI_START          WD_CTL_CODE(0x9ad)
    ...
    #define WD_FUNCTION(wFuncNum, h, pParam, dwSize, fWait) \
        ...
        #define WD_CloseLocal(h)\
                ...
                PVOID pParam, DWORD dwSize, BOOL fWait)
            {
                ...
                ((DWORD) DeviceIoControl(h, (DWORD)wFuncNum, pParam, dwSize, &rc, sizeof(DWORD),
                    &dwTmp, NULL));
                return rc;
            }
        #elif defined(WIN32)
