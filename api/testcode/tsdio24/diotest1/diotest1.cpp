...
// In this test, only the LEDs are interacted with
...
int main(int argc, char *argv[])
{
  ...
  pc104_start = (unsigned char *)mmap(0, size, PROT_READ|PROT_WRITE, MAP_SHARED, fd, PC104);
  ...
  *dio24_r7 = 0xFF; //Port C off.
  ...
  printf("Lighting everything but D31\n");
  *dio24_r7 = 0x01; // Lighting everything but LED 31
