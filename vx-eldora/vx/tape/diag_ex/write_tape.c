...
int write_tape(unsigned int *data_addr,unsigned int data_len,unsigned char sgflg,unsigned char drv_num)
{
...
if(sgflg==0x69)
  parmblk[cmnd_ident].addr_mod = 0x3D;
if(sgflg==0x68)
...
switch(parmblk[cmnd_ident].stat_flags)
  {
    ...
    case 0xE0:
      ...
      break;
    case 0x50:
      printf("WRITE COMMAND NOT COMPLETE DUE TO TRUNCATED DATA\n");
      stat=1;
      break;
    case 0x60:
